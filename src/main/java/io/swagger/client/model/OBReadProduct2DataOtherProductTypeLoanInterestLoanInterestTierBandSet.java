...
import io.swagger.client.model.OBInterestCalculationMethod1Code;
import io.swagger.client.model.OBOtherCodeType10;
import io.swagger.client.model.OBReadProduct2DataOtherProductTypeLoanInterestLoanInterestFeesCharges;
import io.swagger.client.model.OBReadProduct2DataOtherProductTypeLoanInterestLoanInterestTierBand;
...
public class OBReadProduct2DataOtherProductTypeLoanInterestLoanInterestTierBandSet {
  ...
  **/
  @Schema(required = true, description = "The methodology of how credit interest is charged. It can be:- 1. Banded Interest rates are banded. i.e. Increasing rate on whole balance as balance increases. 2. Tiered Interest rates are tiered. i.e. increasing rate for each tier as balance increases, but interest paid on tier fixed for that tier and not on whole balance. 3. Whole The same interest rate is applied irrespective of the SME Loan balance")
  ...
  **/
  @Schema(description = "Loan interest tierbandset identification. Used by  loan providers for internal use purpose.")
