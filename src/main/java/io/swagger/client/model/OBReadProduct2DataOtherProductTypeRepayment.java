...
import io.swagger.client.model.OBReadProduct2DataOtherProductTypeRepaymentOtherAmountType;
import io.swagger.client.model.OBReadProduct2DataOtherProductTypeRepaymentOtherRepaymentFrequency;
import io.swagger.client.model.OBReadProduct2DataOtherProductTypeRepaymentOtherRepaymentType;
import io.swagger.client.model.OBReadProduct2DataOtherProductTypeRepaymentRepaymentFeeCharges;
import io.swagger.client.model.OBReadProduct2DataOtherProductTypeRepaymentRepaymentHoliday;
...
public class OBReadProduct2DataOtherProductTypeRepayment {
  ...
  public enum RepaymentFrequencyEnum {
    ...
    public static class Adapter extends TypeAdapter<RepaymentFrequencyEnum> {
      ...
      public RepaymentFrequencyEnum read(final JsonReader jsonReader) throws IOException {
        String value = jsonReader.nextString();
        return RepaymentFrequencyEnum.fromValue(String.valueOf(value));
      }
    }
  ...
  **/
   ...
   * @return amountType
  **/
  @Schema(description = "The repayment is for paying just the interest only or both interest and capital or bullet amount or balance to date etc")
