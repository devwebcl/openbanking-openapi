...
import io.swagger.client.model.CreditInterest1TierBand;
...
public class CreditInterest1TierBandSet {
  ...
  public enum CalculationMethodEnum {
    ...
    public static class Adapter extends TypeAdapter<CalculationMethodEnum> {
      ...
      public CalculationMethodEnum read(final JsonReader jsonReader) throws IOException {
        String value = jsonReader.nextString();
        return CalculationMethodEnum.fromValue(String.valueOf(value));
      }
    }
  ...
  **/
  @Schema(description = "Methods of calculating interest")
   ...
   * @return destination
  **/
  @Schema(description = "Describes whether accrued interest is payable only to the PCA or to another bank account")
   ...
   * @return notes
  **/
  @Schema(description = "Optional additional notes to supplement the Tier Band Set details")
   ...
   * @return tierBand
  **/
  @Schema(required = true, description = "Tier Band Details")
