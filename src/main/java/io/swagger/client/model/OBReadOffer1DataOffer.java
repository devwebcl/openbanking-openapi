...
import io.swagger.client.model.OBReadOffer1DataAmount;
import io.swagger.client.model.OBReadOffer1DataFee;
...
public class OBReadOffer1DataOffer {
  ...
  **/
   ...
   * @return offerId
  **/
  @Schema(description = "A unique and immutable identifier used to identify the offer resource. This identifier has no meaning to the account owner.")
   ...
   * @return offerType
  **/
  @Schema(description = "Offer type, in a coded form.")
   ...
   * @return description
  **/
  @Schema(description = "Further details of the offer.")
  ...
  **/
  @Schema(description = "Date and time at which the offer starts.All dates in the JSON payloads are represented in ISO 8601 date-time format.  All date-time fields in responses must include the timezone. An example is below: 2017-04-05T10:43:07+00:00")
   ...
   * @return endDateTime
  **/
  @Schema(description = "Date and time at which the offer ends.All dates in the JSON payloads are represented in ISO 8601 date-time format.  All date-time fields in responses must include the timezone. An example is below: 2017-04-05T10:43:07+00:00")
  ...
  **/
   ...
   * @return value
  **/
  @Schema(description = "Value associated with the offer type.")
   ...
   * @return term
  **/
  @Schema(description = "Further details of the term of the offer.")
   ...
   * @return URL
  **/
  @Schema(description = "URL (Uniform Resource Locator) where documentation on the offer can be found")
